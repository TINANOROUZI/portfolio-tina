...
/* --- Your official links --- */
const LINKEDIN =
  "https://www.linkedin.com/in/tinanorouzimoghaddam?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app";
const GITHUB   = "https://github.com/TINANOROUZI";
const EMAIL    = "mailto:tinanoruzi14@gmail.com";
const TELEGRAM = "https://t.me/tinanoruzi";
...
export default function OverlayMenu({ open, onClose }) {
  ...
  const stripes = [
    { label: "Github",   href: GITHUB,   color: "#25282d", Icon: Ico.GitHub },
    { label: "LinkedIn", href: LINKEDIN, color: "#0b5fa4", Icon: Ico.LinkedIn },
    { label: "Email",    href: EMAIL,    color: "#35aef3", Icon: Ico.Email },
    { label: "Telegram", href: TELEGRAM, color: "#0b62f5", Icon: Ico.Telegram },
  ];
          ...
          <ul className="w-full max-w-[520px] space-y-5">
            {menu.map((m, i) => (
              <li key={m.label} className="reveal" data-delay={i + 1} onMouseEnter={() => setActive(i)}>
                <a href={m.href} onClick={onClose} className="menu-link">
